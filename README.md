...
### 1. Prerequisites
- [<img alt="Java 21" src="https://img.shields.io/badge/Java-21.0.5-LTS-ED8B00.svg?logo=openjdk">](https://openjdk.org/projects/jdk/21/): required for Spring Boot 3.4.4 (Spring Boot starters for `web`, `security`, `oauth2-client`, `oauth2-resource-server`, `oauth2-jose`, `keycloak-spring-boot-starter` and `jackson-databind`)
